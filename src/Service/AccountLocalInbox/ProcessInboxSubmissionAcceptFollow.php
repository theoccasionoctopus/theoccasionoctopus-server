...
class ProcessInboxSubmissionAcceptFollow extends ProcessInboxSubmissionBase
{
    public function canHandle(InboxSubmission $inboxSubmission)
    {
        return $inboxSubmission->getData()['type'] == 'Accept' &&  $inboxSubmission->getData()['object']['type'] == 'Follow';
    }
    ...
    public function handle(InboxSubmission $inboxSubmission)
    {
        ...
        $this->logger->info(
            'Got approval that local account can follow remote account',
